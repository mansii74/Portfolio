    ...
    <div className="container mx-auto px-6">
      ...
      <div className="max-w-4xl mx-auto mb-12">
        <div className="bg-gray-800/50 rounded-xl p-8 border border-gray-700">
          {/* LOR Description */}
          <h3 className="text-xl font-bold text-white mb-4">Letter of Recommendation</h3>
          <p className="text-gray-300 mb-6">
            This Letter of Recommendation highlights my work and achievements during my internship at Pixel Creatives. It showcases my contributions to the company and provides insights into my role as a Data Analyst Intern.
          </p>
          
          {/* LOR Button with Slider Transition */}
          <motion.div
            initial={{ x: "-100%", opacity: 0 }}   /* slider-in from left */
          ...
          >
            <motion.a
              ...
              href="/LOR.png"     /* change to /LOR.pdf if you upload a PDF */
              target="_blank"
